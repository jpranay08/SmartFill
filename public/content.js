...
let SELECTED_MODEL =localStorage.getItem('SELECTED_MODEL') || 'google/gemini-2.0-flash-thinking-exp:free';
...
function getTextFieldContext(inputElement) {
    ...
    let closestHeading = inputElement.closest("form, div")?.querySelector("h1, h2, h3, p");
    if (closestHeading) {
